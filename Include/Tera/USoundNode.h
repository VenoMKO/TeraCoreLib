...
public:
  ...
  bool Visit(class USoundNodeWave* wave);
...
public:
  ...
  // Export to Unreal Engine 4. loop - seamless wave looping. attScale - custom attenuation scale.
  FString ExportCueToText(bool loop, float attScale);
};
